...
$(document).ready( function() {
    ...
    document.getElementById('button-train').onclick = function(e) {
        ...
        $.ajax({
            url : '/face_recognition_train_process',
            type : 'POST',
            data : formData,
            processData: false,  // tell jQuery not to process the data
            contentType: false,  // tell jQuery not to set contentType
            success : function(data) {
                alert("Berhasil melakukan train gambar.");
            },
            error: function() {
